    ...
    <div className="about">
        ...
        <div className="about-content">
            ...
            <section className="about-we-are">
                <div>
                    <p>a student group composed of believers in Christ from various backgrounds, and we stand absolutely
                    ...
                    <p>We warmly receive all believers as our brothers and sisters in Christ and seek to maintain the oneness
            ...
            <section className="about-faith">
                <h2>Our Faith</h2>
                <p>Christians on Campus at UC Berkeley members hold the faith which is common to all believers (Titus 1:4; Jude 3):</p>
                <ul>
                    <li>The Bible is the complete divine revelation inspired word-by-word by God through the Holy Spirit (2 Pet. 1:21; 2 Tim. 3:16).</li>
                    <li>God is uniquely one, yet triune — the Father, the Son, and the Spirit (1 Tim. 2:5a; Matt. 28:19).</li>
                    <li>The Son of God, even God Himself, was incarnated to be a man by the name of Jesus Christ (John 1:1, 14).</li>
                    ...
                    <li>Christ ascended to the right hand of God to be Lord of all (Acts 1:9, 2:33, 36).</li>
                    <li>Whenever any person repents to God and believes in the Lord Jesus Christ, he is regenerated (born again) and becomes a living member of the Body of Christ (Acts 20:21; John 3:3; Eph. 1:22-23; Rom. 12:5).</li>
