...
export default (props) => {
    return (
        <section className="detail-page">
            <div className="detail-splash small-groups-splash">
                <h2 className="head2">Small Groups</h2>
            </div>
            ...
            <section className="detail-content small-groups-content">
                ...
                in your Christian life and you need some more experienced Christians to give 
                you some guidance? Small groups are one way to meet those needs.</p>

                <p className="paragraph">There are many Berkeley alumni around the area who graciously host students 
                in their homes Thursday and Friday night for home-cooked meals, a place to 
                rest, and much-needed fellowship. Praise the Lord for a house-to-house 
                Christian life!</p>

                <p className="paragraph">Sign up below, indicate you your interest in small group fellowship, 
                    and we will get you connected. </p>
            </section>
        </section>
    )
}